...
~~~~~~~~~~~ ~ ~ ~ ### @ @ @                                  @ @ @ ### ~ ~ ~ ~~~~~~~~~~~\n`, () => {
  test('Test No. 1', async () => {
    await expect(numberFormatter('234')).toEqual(expect.objectContaining({
      success: false
    }));
  });
  ...
  test('Test No. 4', async () => {
    ...
    await expect(numberFormatter(234234)).toEqual(expect.objectContaining({
      data: {
        number: '234K'
      }
    }));
  ...
  test('Test No. 7', async () => {
    ...
    await expect(numberFormatter(234.234)).toEqual(expect.objectContaining({
      data: {
        number: '234.23'
      }
    }));
  ...
  test('Test No. 8', async () => {
    ...
    await expect(numberFormatter(0.234)).toEqual(expect.objectContaining({
      data: {
        number: '0'
      }
    }));
  ...
  test('Test No. 10', async () => {
    ...
    await expect(numberFormatter(1000000000)).toEqual(expect.objectContaining({
      data: {
        number: '1G'
      }
    }));
  ...
  test('Test No. 11', async () => {
    ...
    await expect(numberFormatter(100000000)).toEqual(expect.objectContaining({
      data: {
        number: '0.1G'
      }
    }));
  ...
  test('Test No. 12', async () => {
    ...
    await expect(numberFormatter(10000000)).toEqual(expect.objectContaining({
      data: {
        number: '10M'
      }
    }));
  ...
  test('Test No. 13', async () => {
    ...
    await expect(numberFormatter(1000000)).toEqual(expect.objectContaining({
      data: {
        number: '1.0M'
      }
    }));
  ...
  test('Test No. 14', async () => {
    ...
    await expect(numberFormatter(234234.234)).toEqual(expect.objectContaining({
      data: {
        number: '234,234.23'
      }
    }));
  ...
  test('Test No. 16', async () => {
    ...
    await expect(numberFormatter(-1234)).toEqual(expect.objectContaining({
      data: {
        number: '-1.2K'
      }
    }));
  ...
  test('Test No. 17', async () => {
    ...
    await expect(numberFormatter(-0.5)).toEqual(expect.objectContaining({
      data: {
        number: '-0.5'
      }
    }));
  ...
  test('Test No. 19', async () => {
    ...
    await expect(numberFormatter(5000000000)).toEqual(expect.objectContaining({
      data: {
...
test('specialCharModifier', async () => {
  utils.setConfig('specialCharsModifier', {
    exceptions: '@#$'
  });
  await expect(utils.specialCharsModifier('av!iv @ avisrur $# !&*')).toStrictEqual({
    success: true,
...
test('specialCharModifier', async () => {
  await expect(utils.specialCharsModifier(12345)).toStrictEqual({
    success: false,
